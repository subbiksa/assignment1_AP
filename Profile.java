...
public class Profile{//creation of new class Profile(super class)
    ...
    public void deleteProfile() {//method to delete the profile
    	...
    	lis.add("Monica Geller");//add to the list
    	System.out.println("List of Profiles");
    	for(String value:lis) {
    		System.out.println(" "+value);//display the list of values
    	}
    	lis.remove(0);//remove the value at arg 0
